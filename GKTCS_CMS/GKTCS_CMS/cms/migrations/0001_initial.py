# Generated by Django 5.1.5 on 2025-03-07 14:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, related_name='cmsuser', to='auth.group')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='cmsuser_permissions', to='auth.permission')),
            ],
            options={
                'db_table': 'cmsuser',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='media', to='cms.content')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='cms.content')),
            ],
        ),
    ]
